...
public class SeleniumExtentreport {
	...
	public void beforeClass() {
		...
		report = new ExtentReports("C:\\Users\\AZIZ\\Desktop\\logintest.html");
	...
	@AfterMethod 
	 public void teardown(ITestResult testResult)
	 {
		if(testResult.getStatus() == ITestResult.FAILURE) {
			String path=Screenshots.takeScreen(driver,testResult.getName());
			String imagepath=test.addScreenCapture(path);
			test.log(LogStatus.FAIL,"Very welcome text failed",imagepath);
		}
		report.endTest(test);
		report.flush();
	}
